...
export const AboutTypes = {
    ...
    aboutSkills: [
        { id: '1', title: 'Web Development', description: 'I am a good Developer', imgUrl: ConstImages.about1 },
        { id: '2', title: 'Web Design', description: 'I am a good Developer', imgUrl: ConstImages.about2 },
        { id: '3', title: 'UI/UX', description: 'I am a good Developer', imgUrl: ConstImages.about3 },
        { id: '4', title: 'Web Animation', description: 'I am a good Developer', imgUrl: ConstImages.about4 },
    ],
    ThunkState: {
        AboutLoading: false,
        AboutMessage: "",
