                            ...
                            {item?.isConfidential ? (
                                ...
                                <div className='confidential-container absolute inset-0 flex items-center justify-center bg-black opacity-0  hover:opacity-100 bg-opacity-0 hover:bg-opacity-50 transition duration-300'>
                                    <a href={item?.codeLink} className='confidential-text'>
                                        <GitHub sx={{ fontSize: { xs: '30px', md: '80px' } }} className='text-white transform  transition duration-300 hover:scale-125 bg-gray-700 hover:bg-blue-500 rounded-full p-2' />
                                    </a>
                                </div>
                            )}
                        </div>
                        ...
                        <div className='description-container' >
                            ...
                            <div className='dev-tools-box'>
                                ...
                                {!item?.isConfidential && (
                                    <a
                                        href={item?.codeLink}
                                        className='mt-5 pl-4 font-palanquin md:hidden text-md text-coral-blue transform transition-transform duration-300 hover:scale-105'
                                    >
                                        Link-Code
                                    </a>
                                )}
