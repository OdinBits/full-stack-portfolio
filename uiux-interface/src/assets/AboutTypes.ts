...
export const AboutTypes = {
    ...
    themeText: {
        firstParagraph:"I am a full-stack developer. I have a strong background in computer science and software engineering. I have worked on projects projects focusing on using modern web technologies. I create quality,clean,detailed and maintainable web applications, ready to scale for a range of vast users. I can help you deliver a seamless and engaging experience to your users.Background in computer science and ability as a full-stack developer (front-end and back-end) allow me to create everything from small business websites to custom web applications.",
